...
domain: [consulting, contract-analysis, ai-completeness]
status: active
...
gap analysis. Contains all deliverables, communications, and analysis.
...
- Confidential: do not reference content in other folder contexts

## Tone and voice
Formal, precise, evidence-based. Direct. C-suite audience.
